        ...
        return parent -> {
            ...
            return YetAnotherConfigLib.createBuilder()
                ...
                .category(ConfigCategory.createBuilder()
                    ...
                    .tooltip(Text.literal("Set a command for each shortcut key. Bind the keys in Options > Controls > Misc."))
                    .option(Option.<String>createBuilder()
                        .name(Text.literal("Shortcut 1"))
                        .description(OptionDescription.of(Text.literal("Command to run when Shortcut 1 key is pressed (e.g. /home)")))
                        .binding(defaults.shortcut1Command, () -> config.shortcut1Command, v -> config.shortcut1Command = v)
                        .controller(StringControllerBuilder::create)
                        .build())
                    .option(Option.<String>createBuilder()
                        .name(Text.literal("Shortcut 2"))
                        .description(OptionDescription.of(Text.literal("Command to run when Shortcut 2 key is pressed")))
                        .binding(defaults.shortcut2Command, () -> config.shortcut2Command, v -> config.shortcut2Command = v)
                        .controller(StringControllerBuilder::create)
                        .build())
                    .option(Option.<String>createBuilder()
                        .name(Text.literal("Shortcut 3"))
                        .description(OptionDescription.of(Text.literal("Command to run when Shortcut 3 key is pressed")))
                        .binding(defaults.shortcut3Command, () -> config.shortcut3Command, v -> config.shortcut3Command = v)
                        .controller(StringControllerBuilder::create)
                        .build())
                    .option(Option.<String>createBuilder()
                        .name(Text.literal("Shortcut 4"))
                        .description(OptionDescription.of(Text.literal("Command to run when Shortcut 4 key is pressed")))
                        .binding(defaults.shortcut4Command, () -> config.shortcut4Command, v -> config.shortcut4Command = v)
                        .controller(StringControllerBuilder::create)
                        .build())
                    .option(Option.<String>createBuilder()
                        .name(Text.literal("Shortcut 5"))
                        .description(OptionDescription.of(Text.literal("Command to run when Shortcut 5 key is pressed")))
                        .binding(defaults.shortcut5Command, () -> config.shortcut5Command, v -> config.shortcut5Command = v)
                        .controller(StringControllerBuilder::create)
                        .build())
                    .build())
